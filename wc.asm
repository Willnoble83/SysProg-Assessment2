...
void printf(int fd, const char *fmt, ...) {
 ...
 714:	e9 8f fe ff ff       	jmp    5a8 <printf+0x48>
                    s = "(null)";
 719:	bb 1f 09 00 00       	mov    $0x91f,%ebx
                while (*s != 0) {
...
int test(void)
{
 ...
 8d3:	83 ec 10             	sub    $0x10,%esp
    printf(1,"Tested!");
 8d6:	68 39 09 00 00       	push   $0x939
 8db:	6a 01                	push   $0x1
 8dd:	e8 7e fc ff ff       	call   560 <printf>
    return 0;
