...
void printf(int fd, const char *fmt, ...) {
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
                    s = "(null)";
 619:	bb 1b 08 00 00       	mov    $0x81b,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 66d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 66f:	a3 1c 0b 00 00       	mov    %eax,0xb1c
}
 674:	5b                   	pop    %ebx
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
...
void* malloc(uint nbytes) {
 ...
 70f:	73 47                	jae    758 <malloc+0x98>
        ...
        if (p == freep) {
 711:	39 05 1c 0b 00 00    	cmp    %eax,0xb1c
 ...
 736:	e8 f5 fe ff ff       	call   630 <free>
    return freep;
 73b:	8b 15 1c 0b 00 00    	mov    0xb1c,%edx
 ...
 764:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 767:	89 15 1c 0b 00 00    	mov    %edx,0xb1c
}
 ...
 787:	0b 00 00 
 78a:	c7 05 20 0b 00 00 20 	movl   $0xb20,0xb20
 791:	0b 00 00 
        base.s.size = 0;
 794:	b8 20 0b 00 00       	mov    $0xb20,%eax
 799:	c7 05 24 0b 00 00 00 	movl   $0x0,0xb24
 7a0:	00 00 00 
...
int test(void)
{
 ...
 7d3:	83 ec 10             	sub    $0x10,%esp
    printf(1,"Tested!");
 7d6:	68 35 08 00 00       	push   $0x835
 7db:	6a 01                	push   $0x1
 7dd:	e8 7e fc ff ff       	call   460 <printf>
    return 0;
 7e2:	31 c0                	xor    %eax,%eax
 7e4:	c9                   	leave  
 7e5:	c3                   	ret    
