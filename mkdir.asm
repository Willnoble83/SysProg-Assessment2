...
void printf(int fd, const char *fmt, ...) {
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
                    s = "(null)";
 609:	bb 0b 08 00 00       	mov    $0x80b,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 621:	a1 0c 0b 00 00       	mov    0xb0c,%eax
void free(void *ap) {
 ...
 65d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 65f:	a3 0c 0b 00 00       	mov    %eax,0xb0c
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 69a:	a3 0c 0b 00 00       	mov    %eax,0xb0c
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 6bc:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
        ...
        if (p == freep) {
 701:	39 05 0c 0b 00 00    	cmp    %eax,0xb0c
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
    return freep;
 72b:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 757:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 ...
 769:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 770:	c7 05 0c 0b 00 00 10 	movl   $0xb10,0xb0c
 777:	0b 00 00 
 77a:	c7 05 10 0b 00 00 10 	movl   $0xb10,0xb10
 781:	0b 00 00 
        base.s.size = 0;
 784:	b8 10 0b 00 00       	mov    $0xb10,%eax
 789:	c7 05 14 0b 00 00 00 	movl   $0x0,0xb14
 790:	00 00 00 
...
int test(void)
{
 ...
 7c3:	83 ec 10             	sub    $0x10,%esp
    printf(1,"Tested!");
 7c6:	68 25 08 00 00       	push   $0x825
 7cb:	6a 01                	push   $0x1
 7cd:	e8 7e fc ff ff       	call   450 <printf>
    return 0;
