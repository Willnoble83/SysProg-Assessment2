...
void printf(int fd, const char *fmt, ...) {
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
                    s = "(null)";
 5f9:	bb fb 07 00 00       	mov    $0x7fb,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 64d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 64f:	a3 fc 0a 00 00       	mov    %eax,0xafc
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
...
void* malloc(uint nbytes) {
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 747:	89 15 fc 0a 00 00    	mov    %edx,0xafc
}
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 760:	c7 05 fc 0a 00 00 00 	movl   $0xb00,0xafc
 767:	0b 00 00 
 76a:	c7 05 00 0b 00 00 00 	movl   $0xb00,0xb00
 771:	0b 00 00 
        base.s.size = 0;
 774:	b8 00 0b 00 00       	mov    $0xb00,%eax
 779:	c7 05 04 0b 00 00 00 	movl   $0x0,0xb04
 780:	00 00 00 
