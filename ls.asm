...
00000060 <fmtname>:
{
  ...
  d7:	05 34 0e 00 00       	add    $0xe34,%eax
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 687:	f7 f1                	div    %ecx
 689:	0f b6 92 cc 0a 00 00 	movzbl 0xacc(%edx),%edx
    }
    while ((x /= base) != 0);
...
void printf(int fd, const char *fmt, ...) {
 ...
 8a4:	e9 8f fe ff ff       	jmp    738 <printf+0x48>
                    s = "(null)";
 8a9:	bb c2 0a 00 00       	mov    $0xac2,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 8c1:	a1 44 0e 00 00       	mov    0xe44,%eax
void free(void *ap) {
 ...
 8fd:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 8ff:	a3 44 0e 00 00       	mov    %eax,0xe44
}
 904:	5b                   	pop    %ebx
 905:	5e                   	pop    %esi
 906:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 937:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 93a:	a3 44 0e 00 00       	mov    %eax,0xe44
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 959:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 95c:	8b 15 44 0e 00 00    	mov    0xe44,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 99f:	73 47                	jae    9e8 <malloc+0x98>
        ...
        if (p == freep) {
 9a1:	39 05 44 0e 00 00    	cmp    %eax,0xe44
 ...
 9c6:	e8 f5 fe ff ff       	call   8c0 <free>
    return freep;
 9cb:	8b 15 44 0e 00 00    	mov    0xe44,%edx
 ...
 9f4:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 9f7:	89 15 44 0e 00 00    	mov    %edx,0xe44
}
 ...
 a09:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 a10:	c7 05 44 0e 00 00 48 	movl   $0xe48,0xe44
 a17:	0e 00 00 
 a1a:	c7 05 48 0e 00 00 48 	movl   $0xe48,0xe48
 a21:	0e 00 00 
        base.s.size = 0;
 a24:	b8 48 0e 00 00       	mov    $0xe48,%eax
 a29:	c7 05 4c 0e 00 00 00 	movl   $0x0,0xe4c
 a30:	00 00 00 
...
int test(void)
{
 ...
 a63:	83 ec 10             	sub    $0x10,%esp
    printf(1,"Tested!");
 a66:	68 dd 0a 00 00       	push   $0xadd
 a6b:	6a 01                	push   $0x1
 a6d:	e8 7e fc ff ff       	call   6f0 <printf>
    return 0;
