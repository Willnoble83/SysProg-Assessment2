...
00000060 <fmtname>:
{
  ...
  d7:	05 54 0e 00 00       	add    $0xe54,%eax
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 6a7:	f7 f1                	div    %ecx
 6a9:	0f b6 92 ec 0a 00 00 	movzbl 0xaec(%edx),%edx
    }
    while ((x /= base) != 0);
...
void printf(int fd, const char *fmt, ...) {
 ...
 8c4:	e9 8f fe ff ff       	jmp    758 <printf+0x48>
                    s = "(null)";
 8c9:	bb e2 0a 00 00       	mov    $0xae2,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 8e1:	a1 64 0e 00 00       	mov    0xe64,%eax
void free(void *ap) {
 ...
 91d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 91f:	a3 64 0e 00 00       	mov    %eax,0xe64
}
 924:	5b                   	pop    %ebx
 925:	5e                   	pop    %esi
 926:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 957:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 95a:	a3 64 0e 00 00       	mov    %eax,0xe64
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 979:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 97c:	8b 15 64 0e 00 00    	mov    0xe64,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 9bf:	73 47                	jae    a08 <malloc+0x98>
        ...
        if (p == freep) {
 9c1:	39 05 64 0e 00 00    	cmp    %eax,0xe64
 ...
 9e6:	e8 f5 fe ff ff       	call   8e0 <free>
    return freep;
 9eb:	8b 15 64 0e 00 00    	mov    0xe64,%edx
 ...
 a14:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 a17:	89 15 64 0e 00 00    	mov    %edx,0xe64
}
 ...
 a29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 a30:	c7 05 64 0e 00 00 68 	movl   $0xe68,0xe64
 a37:	0e 00 00 
 a3a:	c7 05 68 0e 00 00 68 	movl   $0xe68,0xe68
 a41:	0e 00 00 
        base.s.size = 0;
 a44:	b8 68 0e 00 00       	mov    $0xe68,%eax
 a49:	c7 05 6c 0e 00 00 00 	movl   $0x0,0xe6c
 a50:	00 00 00 
...
int test(void)
{
 ...
 a83:	83 ec 10             	sub    $0x10,%esp
    printf(1,"Tested!");
 a86:	68 fd 0a 00 00       	push   $0xafd
 a8b:	6a 01                	push   $0x1
 a8d:	e8 7e fc ff ff       	call   710 <printf>
    return 0;
