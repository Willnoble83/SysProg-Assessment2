...
00000060 <fmtname>:
{
  ...
  d7:	05 44 0e 00 00       	add    $0xe44,%eax
...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 697:	f7 f1                	div    %ecx
 699:	0f b6 92 dc 0a 00 00 	movzbl 0xadc(%edx),%edx
    }
    while ((x /= base) != 0);
...
void printf(int fd, const char *fmt, ...) {
 ...
 8b4:	e9 8f fe ff ff       	jmp    748 <printf+0x48>
                    s = "(null)";
 8b9:	bb d2 0a 00 00       	mov    $0xad2,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 8d1:	a1 54 0e 00 00       	mov    0xe54,%eax
void free(void *ap) {
 ...
 90d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 90f:	a3 54 0e 00 00       	mov    %eax,0xe54
}
 914:	5b                   	pop    %ebx
 915:	5e                   	pop    %esi
 916:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 947:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 94a:	a3 54 0e 00 00       	mov    %eax,0xe54
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 969:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 96c:	8b 15 54 0e 00 00    	mov    0xe54,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 9af:	73 47                	jae    9f8 <malloc+0x98>
        ...
        if (p == freep) {
 9b1:	39 05 54 0e 00 00    	cmp    %eax,0xe54
 ...
 9d6:	e8 f5 fe ff ff       	call   8d0 <free>
    return freep;
 9db:	8b 15 54 0e 00 00    	mov    0xe54,%edx
 ...
 a04:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 a07:	89 15 54 0e 00 00    	mov    %edx,0xe54
}
 ...
 a19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 a20:	c7 05 54 0e 00 00 58 	movl   $0xe58,0xe54
 a27:	0e 00 00 
 a2a:	c7 05 58 0e 00 00 58 	movl   $0xe58,0xe58
 a31:	0e 00 00 
        base.s.size = 0;
 a34:	b8 58 0e 00 00       	mov    $0xe58,%eax
 a39:	c7 05 5c 0e 00 00 00 	movl   $0x0,0xe5c
 a40:	00 00 00 
...
int test(void)
{
 ...
 a73:	83 ec 10             	sub    $0x10,%esp
    printf(1,"Tested!");
 a76:	68 ed 0a 00 00       	push   $0xaed
 a7b:	6a 01                	push   $0x1
 a7d:	e8 7e fc ff ff       	call   700 <printf>
    return 0;
