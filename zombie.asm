...
void printf(int fd, const char *fmt, ...) {
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
                    s = "(null)";
 5c9:	bb 98 07 00 00       	mov    $0x798,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 61d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 61f:	a3 8c 0a 00 00       	mov    %eax,0xa8c
}
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 65a:	a3 8c 0a 00 00       	mov    %eax,0xa8c
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 67c:	8b 15 8c 0a 00 00    	mov    0xa8c,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 6bf:	73 47                	jae    708 <malloc+0x98>
        ...
        if (p == freep) {
 6c1:	39 05 8c 0a 00 00    	cmp    %eax,0xa8c
 ...
 6e6:	e8 f5 fe ff ff       	call   5e0 <free>
    return freep;
 6eb:	8b 15 8c 0a 00 00    	mov    0xa8c,%edx
 ...
 714:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 717:	89 15 8c 0a 00 00    	mov    %edx,0xa8c
}
 ...
 737:	0a 00 00 
 73a:	c7 05 90 0a 00 00 90 	movl   $0xa90,0xa90
 741:	0a 00 00 
        base.s.size = 0;
 744:	b8 90 0a 00 00       	mov    $0xa90,%eax
 749:	c7 05 94 0a 00 00 00 	movl   $0x0,0xa94
 750:	00 00 00 
...
int test(void)
{
 ...
 783:	83 ec 10             	sub    $0x10,%esp
    printf(1,"Tested!");
 786:	68 b1 07 00 00       	push   $0x7b1
 78b:	6a 01                	push   $0x1
 78d:	e8 7e fc ff ff       	call   410 <printf>
    return 0;
