...
void printf(int fd, const char *fmt, ...) {
 ...
 594:	e9 8f fe ff ff       	jmp    428 <printf+0x48>
                    s = "(null)";
 599:	bb 68 07 00 00       	mov    $0x768,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 5ed:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 5ef:	a3 5c 0a 00 00       	mov    %eax,0xa5c
}
 5f4:	5b                   	pop    %ebx
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
...
void* malloc(uint nbytes) {
 ...
 68f:	73 47                	jae    6d8 <malloc+0x98>
        ...
        if (p == freep) {
 691:	39 05 5c 0a 00 00    	cmp    %eax,0xa5c
 ...
 6b6:	e8 f5 fe ff ff       	call   5b0 <free>
    return freep;
 6bb:	8b 15 5c 0a 00 00    	mov    0xa5c,%edx
 ...
 6e4:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 6e7:	89 15 5c 0a 00 00    	mov    %edx,0xa5c
}
 ...
 6f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 700:	c7 05 5c 0a 00 00 60 	movl   $0xa60,0xa5c
 707:	0a 00 00 
 70a:	c7 05 60 0a 00 00 60 	movl   $0xa60,0xa60
 711:	0a 00 00 
        base.s.size = 0;
 714:	b8 60 0a 00 00       	mov    $0xa60,%eax
 719:	c7 05 64 0a 00 00 00 	movl   $0x0,0xa64
 720:	00 00 00 
...
int test(void)
{
 ...
 753:	83 ec 10             	sub    $0x10,%esp
    printf(1,"Tested!");
 756:	68 81 07 00 00       	push   $0x781
 75b:	6a 01                	push   $0x1
 75d:	e8 7e fc ff ff       	call   3e0 <printf>
    return 0;
