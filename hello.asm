...
void printf(int fd, const char *fmt, ...) {
 ...
 5a4:	e9 8f fe ff ff       	jmp    438 <printf+0x48>
                    s = "(null)";
 5a9:	bb 78 07 00 00       	mov    $0x778,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 5fd:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 5ff:	a3 6c 0a 00 00       	mov    %eax,0xa6c
}
 604:	5b                   	pop    %ebx
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
...
void* malloc(uint nbytes) {
 ...
 69f:	73 47                	jae    6e8 <malloc+0x98>
        ...
        if (p == freep) {
 6a1:	39 05 6c 0a 00 00    	cmp    %eax,0xa6c
 ...
 6c6:	e8 f5 fe ff ff       	call   5c0 <free>
    return freep;
 6cb:	8b 15 6c 0a 00 00    	mov    0xa6c,%edx
 ...
 6f4:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 6f7:	89 15 6c 0a 00 00    	mov    %edx,0xa6c
}
 ...
 709:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 710:	c7 05 6c 0a 00 00 70 	movl   $0xa70,0xa6c
 717:	0a 00 00 
 71a:	c7 05 70 0a 00 00 70 	movl   $0xa70,0xa70
 721:	0a 00 00 
        base.s.size = 0;
 724:	b8 70 0a 00 00       	mov    $0xa70,%eax
 729:	c7 05 74 0a 00 00 00 	movl   $0x0,0xa74
 730:	00 00 00 
...
int test(void)
{
 ...
 763:	83 ec 10             	sub    $0x10,%esp
    printf(1,"Tested!");
 766:	68 91 07 00 00       	push   $0x791
 76b:	6a 01                	push   $0x1
 76d:	e8 7e fc ff ff       	call   3f0 <printf>
    return 0;
