...
void printf(int fd, const char *fmt, ...) {
 ...
 684:	e9 8f fe ff ff       	jmp    518 <printf+0x48>
                    s = "(null)";
 689:	bb a8 08 00 00       	mov    $0x8a8,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 6dd:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 6df:	a3 a8 0b 00 00       	mov    %eax,0xba8
}
 6e4:	5b                   	pop    %ebx
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 71a:	a3 a8 0b 00 00       	mov    %eax,0xba8
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 73c:	8b 15 a8 0b 00 00    	mov    0xba8,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 77f:	73 47                	jae    7c8 <malloc+0x98>
        ...
        if (p == freep) {
 781:	39 05 a8 0b 00 00    	cmp    %eax,0xba8
 ...
 7a6:	e8 f5 fe ff ff       	call   6a0 <free>
    return freep;
 7ab:	8b 15 a8 0b 00 00    	mov    0xba8,%edx
 ...
 7d4:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 7d7:	89 15 a8 0b 00 00    	mov    %edx,0xba8
}
 ...
 7f7:	0b 00 00 
 7fa:	c7 05 ac 0b 00 00 ac 	movl   $0xbac,0xbac
 801:	0b 00 00 
        base.s.size = 0;
 804:	b8 ac 0b 00 00       	mov    $0xbac,%eax
 809:	c7 05 b0 0b 00 00 00 	movl   $0x0,0xbb0
 810:	00 00 00 
