...
void printf(int fd, const char *fmt, ...) {
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
                    s = "(null)";
 669:	bb 88 08 00 00       	mov    $0x888,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 681:	a1 88 0b 00 00       	mov    0xb88,%eax
void free(void *ap) {
 ...
 6bd:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 6bf:	a3 88 0b 00 00       	mov    %eax,0xb88
}
 6c4:	5b                   	pop    %ebx
 6c5:	5e                   	pop    %esi
 6c6:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 6fa:	a3 88 0b 00 00       	mov    %eax,0xb88
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 71c:	8b 15 88 0b 00 00    	mov    0xb88,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 75f:	73 47                	jae    7a8 <malloc+0x98>
        ...
        if (p == freep) {
 761:	39 05 88 0b 00 00    	cmp    %eax,0xb88
 ...
 786:	e8 f5 fe ff ff       	call   680 <free>
    return freep;
 78b:	8b 15 88 0b 00 00    	mov    0xb88,%edx
 ...
 7b4:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 7b7:	89 15 88 0b 00 00    	mov    %edx,0xb88
}
 ...
 7c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 88 0b 00 00 8c 	movl   $0xb8c,0xb88
 7d7:	0b 00 00 
 7da:	c7 05 8c 0b 00 00 8c 	movl   $0xb8c,0xb8c
 7e1:	0b 00 00 
        base.s.size = 0;
 7e4:	b8 8c 0b 00 00       	mov    $0xb8c,%eax
 7e9:	c7 05 90 0b 00 00 00 	movl   $0x0,0xb90
 7f0:	00 00 00 
...
int test(void)
{
 ...
 823:	83 ec 10             	sub    $0x10,%esp
    printf(1,"Tested!");
 826:	68 a1 08 00 00       	push   $0x8a1
 82b:	6a 01                	push   $0x1
 82d:	e8 7e fc ff ff       	call   4b0 <printf>
    return 0;
