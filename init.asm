...
void free(void *ap) {
 ...
 6cd:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 6cf:	a3 98 0b 00 00       	mov    %eax,0xb98
}
 6d4:	5b                   	pop    %ebx
 6d5:	5e                   	pop    %esi
 6d6:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 707:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 70a:	a3 98 0b 00 00       	mov    %eax,0xb98
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 76f:	73 47                	jae    7b8 <malloc+0x98>
        ...
        if (p == freep) {
 771:	39 05 98 0b 00 00    	cmp    %eax,0xb98
 ...
 796:	e8 f5 fe ff ff       	call   690 <free>
    return freep;
 79b:	8b 15 98 0b 00 00    	mov    0xb98,%edx
 ...
 7c4:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 7c7:	89 15 98 0b 00 00    	mov    %edx,0xb98
}
 ...
 7d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 98 0b 00 00 9c 	movl   $0xb9c,0xb98
 7e7:	0b 00 00 
 7ea:	c7 05 9c 0b 00 00 9c 	movl   $0xb9c,0xb9c
 7f1:	0b 00 00 
        base.s.size = 0;
 7f4:	b8 9c 0b 00 00       	mov    $0xb9c,%eax
 7f9:	c7 05 a0 0b 00 00 00 	movl   $0x0,0xba0
 800:	00 00 00 
...
int test(void)
{
 ...
 833:	83 ec 10             	sub    $0x10,%esp
    printf(1,"Tested!");
 836:	68 b1 08 00 00       	push   $0x8b1
 83b:	6a 01                	push   $0x1
 83d:	e8 7e fc ff ff       	call   4c0 <printf>
    return 0;
 842:	31 c0                	xor    %eax,%eax
 844:	c9                   	leave  
 845:	c3                   	ret    
