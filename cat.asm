...
void printf(int fd, const char *fmt, ...) {
 ...
 6a4:	e9 8f fe ff ff       	jmp    538 <printf+0x48>
                    s = "(null)";
 6a9:	bb b0 08 00 00       	mov    $0x8b0,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 6fd:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 6ff:	a3 e0 0b 00 00       	mov    %eax,0xbe0
}
 704:	5b                   	pop    %ebx
 705:	5e                   	pop    %esi
 706:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 73a:	a3 e0 0b 00 00       	mov    %eax,0xbe0
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 75c:	8b 15 e0 0b 00 00    	mov    0xbe0,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 79f:	73 47                	jae    7e8 <malloc+0x98>
        ...
        if (p == freep) {
 7a1:	39 05 e0 0b 00 00    	cmp    %eax,0xbe0
 ...
 7c6:	e8 f5 fe ff ff       	call   6c0 <free>
    return freep;
 7cb:	8b 15 e0 0b 00 00    	mov    0xbe0,%edx
 ...
 809:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 810:	c7 05 e0 0b 00 00 e4 	movl   $0xbe4,0xbe0
 817:	0b 00 00 
 81a:	c7 05 e4 0b 00 00 e4 	movl   $0xbe4,0xbe4
 821:	0b 00 00 
        base.s.size = 0;
 824:	b8 e4 0b 00 00       	mov    $0xbe4,%eax
 829:	c7 05 e8 0b 00 00 00 	movl   $0x0,0xbe8
 830:	00 00 00 
...
int test(void)
{
 ...
 863:	83 ec 10             	sub    $0x10,%esp
    printf(1,"Tested!");
 866:	68 c9 08 00 00       	push   $0x8c9
 86b:	6a 01                	push   $0x1
 86d:	e8 7e fc ff ff       	call   4f0 <printf>
    return 0;
