...
void printf(int fd, const char *fmt, ...) {
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
                    s = "(null)";
 5f9:	bb ef 07 00 00       	mov    $0x7ef,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 611:	a1 e8 0a 00 00       	mov    0xae8,%eax
void free(void *ap) {
 ...
 64d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 64f:	a3 e8 0a 00 00       	mov    %eax,0xae8
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 68a:	a3 e8 0a 00 00       	mov    %eax,0xae8
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 6ac:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
        ...
        if (p == freep) {
 6f1:	39 05 e8 0a 00 00    	cmp    %eax,0xae8
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
    return freep;
 71b:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 747:	89 15 e8 0a 00 00    	mov    %edx,0xae8
}
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 760:	c7 05 e8 0a 00 00 ec 	movl   $0xaec,0xae8
 767:	0a 00 00 
 76a:	c7 05 ec 0a 00 00 ec 	movl   $0xaec,0xaec
 771:	0a 00 00 
        base.s.size = 0;
 774:	b8 ec 0a 00 00       	mov    $0xaec,%eax
 779:	c7 05 f0 0a 00 00 00 	movl   $0x0,0xaf0
 780:	00 00 00 
...
int test(void)
{
 ...
 7b3:	83 ec 10             	sub    $0x10,%esp
    printf(1,"Tested!");
 7b6:	68 09 08 00 00       	push   $0x809
 7bb:	6a 01                	push   $0x1
 7bd:	e8 7e fc ff ff       	call   440 <printf>
    return 0;
