...
void printf(int fd, const char *fmt, ...) {
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
                    s = "(null)";
 5d9:	bb cf 07 00 00       	mov    $0x7cf,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 5f1:	a1 c8 0a 00 00       	mov    0xac8,%eax
void free(void *ap) {
 ...
 62d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 62f:	a3 c8 0a 00 00       	mov    %eax,0xac8
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 66a:	a3 c8 0a 00 00       	mov    %eax,0xac8
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 68c:	8b 15 c8 0a 00 00    	mov    0xac8,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
        ...
        if (p == freep) {
 6d1:	39 05 c8 0a 00 00    	cmp    %eax,0xac8
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
    return freep;
 6fb:	8b 15 c8 0a 00 00    	mov    0xac8,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 727:	89 15 c8 0a 00 00    	mov    %edx,0xac8
}
 ...
 739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 740:	c7 05 c8 0a 00 00 cc 	movl   $0xacc,0xac8
 747:	0a 00 00 
 74a:	c7 05 cc 0a 00 00 cc 	movl   $0xacc,0xacc
 751:	0a 00 00 
        base.s.size = 0;
 754:	b8 cc 0a 00 00       	mov    $0xacc,%eax
 759:	c7 05 d0 0a 00 00 00 	movl   $0x0,0xad0
 760:	00 00 00 
...
int test(void)
{
 ...
 793:	83 ec 10             	sub    $0x10,%esp
    printf(1,"Tested!");
 796:	68 e9 07 00 00       	push   $0x7e9
 79b:	6a 01                	push   $0x1
 79d:	e8 7e fc ff ff       	call   420 <printf>
    return 0;
