...
void free(void *ap) {
 ...
 63d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 63f:	a3 d8 0a 00 00       	mov    %eax,0xad8
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 67a:	a3 d8 0a 00 00       	mov    %eax,0xad8
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 69c:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 737:	89 15 d8 0a 00 00    	mov    %edx,0xad8
}
 ...
 757:	0a 00 00 
 75a:	c7 05 dc 0a 00 00 dc 	movl   $0xadc,0xadc
 761:	0a 00 00 
        base.s.size = 0;
 764:	b8 dc 0a 00 00       	mov    $0xadc,%eax
 769:	c7 05 e0 0a 00 00 00 	movl   $0x0,0xae0
 770:	00 00 00 
