...
int main()
{
    ...
    DrawLine(0,480/2,640,480/2, 20 ); //Left to right
    ...
    //Draw lines
    DrawLine(320/2, 0, 320/2, 200, 20);  //Top to bottom
    DrawLine(0,200/2,320,200/2, 20 ); //Left to right
    
    //Await user input
    getch();
    videomodetext();
    printf(1, "Cut into 4 finished!\n");
