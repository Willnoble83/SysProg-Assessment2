...
void printf(int fd, const char *fmt, ...) {
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
                    s = "(null)";
 609:	bb e1 07 00 00       	mov    $0x7e1,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 65d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 65f:	a3 dc 0a 00 00       	mov    %eax,0xadc
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 69a:	a3 dc 0a 00 00       	mov    %eax,0xadc
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 6bc:	8b 15 dc 0a 00 00    	mov    0xadc,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
        ...
        if (p == freep) {
 701:	39 05 dc 0a 00 00    	cmp    %eax,0xadc
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
    return freep;
 72b:	8b 15 dc 0a 00 00    	mov    0xadc,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 757:	89 15 dc 0a 00 00    	mov    %edx,0xadc
}
 ...
 777:	0a 00 00 
 77a:	c7 05 e0 0a 00 00 e0 	movl   $0xae0,0xae0
 781:	0a 00 00 
        base.s.size = 0;
 784:	b8 e0 0a 00 00       	mov    $0xae0,%eax
