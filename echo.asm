...
void free(void *ap) {
 ...
 63d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 63f:	a3 bc 0a 00 00       	mov    %eax,0xabc
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 67a:	a3 bc 0a 00 00       	mov    %eax,0xabc
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 69c:	8b 15 bc 0a 00 00    	mov    0xabc,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 6df:	73 47                	jae    728 <malloc+0x98>
        ...
        if (p == freep) {
 6e1:	39 05 bc 0a 00 00    	cmp    %eax,0xabc
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
    return freep;
 70b:	8b 15 bc 0a 00 00    	mov    0xabc,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 737:	89 15 bc 0a 00 00    	mov    %edx,0xabc
}
 ...
 757:	0a 00 00 
 75a:	c7 05 c0 0a 00 00 c0 	movl   $0xac0,0xac0
 761:	0a 00 00 
        base.s.size = 0;
 764:	b8 c0 0a 00 00       	mov    $0xac0,%eax
