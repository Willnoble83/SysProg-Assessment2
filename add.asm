...
int main() {
  ...
  11:	6a 03                	push   $0x3
  13:	6a 01                	push   $0x1
  15:	e8 56 07 00 00       	call   770 <add>
...
void free(void *ap) {
 ...
 61d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 61f:	a3 90 0a 00 00       	mov    %eax,0xa90
}
 624:	5b                   	pop    %ebx
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
...
void* malloc(uint nbytes) {
 ...
 6bf:	73 47                	jae    708 <malloc+0x98>
        ...
        if (p == freep) {
 6c1:	39 05 90 0a 00 00    	cmp    %eax,0xa90
 ...
 6e6:	e8 f5 fe ff ff       	call   5e0 <free>
    return freep;
 6eb:	8b 15 90 0a 00 00    	mov    0xa90,%edx
 ...
 714:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 717:	89 15 90 0a 00 00    	mov    %edx,0xa90
}
 ...
 737:	0a 00 00 
 73a:	c7 05 94 0a 00 00 94 	movl   $0xa94,0xa94
 741:	0a 00 00 
        base.s.size = 0;
 744:	b8 94 0a 00 00       	mov    $0xa94,%eax
