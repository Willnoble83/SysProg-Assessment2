...
int main() {
  ...
  11:	6a 03                	push   $0x3
  13:	6a 01                	push   $0x1
  15:	e8 36 07 00 00       	call   750 <add>
...
void printf(int fd, const char *fmt, ...) {
 ...
 5a4:	e9 8f fe ff ff       	jmp    438 <printf+0x48>
                    s = "(null)";
 5a9:	bb 7c 07 00 00       	mov    $0x77c,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 5fd:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 5ff:	a3 70 0a 00 00       	mov    %eax,0xa70
}
 604:	5b                   	pop    %ebx
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
...
void* malloc(uint nbytes) {
 ...
 69f:	73 47                	jae    6e8 <malloc+0x98>
        ...
        if (p == freep) {
 6a1:	39 05 70 0a 00 00    	cmp    %eax,0xa70
 ...
 6c6:	e8 f5 fe ff ff       	call   5c0 <free>
    return freep;
 6cb:	8b 15 70 0a 00 00    	mov    0xa70,%edx
 ...
 6f4:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 6f7:	89 15 70 0a 00 00    	mov    %edx,0xa70
}
 ...
 717:	0a 00 00 
 71a:	c7 05 74 0a 00 00 74 	movl   $0xa74,0xa74
 721:	0a 00 00 
        base.s.size = 0;
 724:	b8 74 0a 00 00       	mov    $0xa74,%eax
