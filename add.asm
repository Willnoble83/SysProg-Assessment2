...
int main() {
  ...
  11:	6a 03                	push   $0x3
  13:	6a 01                	push   $0x1
  15:	e8 46 07 00 00       	call   760 <add>
...
void printf(int fd, const char *fmt, ...) {
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
                    s = "(null)";
 5b9:	bb 8c 07 00 00       	mov    $0x78c,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 60d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 60f:	a3 80 0a 00 00       	mov    %eax,0xa80
}
 614:	5b                   	pop    %ebx
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
...
void* malloc(uint nbytes) {
 ...
 6af:	73 47                	jae    6f8 <malloc+0x98>
        ...
        if (p == freep) {
 6b1:	39 05 80 0a 00 00    	cmp    %eax,0xa80
 ...
 6d6:	e8 f5 fe ff ff       	call   5d0 <free>
    return freep;
 6db:	8b 15 80 0a 00 00    	mov    0xa80,%edx
 ...
 704:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 707:	89 15 80 0a 00 00    	mov    %edx,0xa80
}
 ...
 727:	0a 00 00 
 72a:	c7 05 84 0a 00 00 84 	movl   $0xa84,0xa84
 731:	0a 00 00 
        base.s.size = 0;
 734:	b8 84 0a 00 00       	mov    $0xa84,%eax
