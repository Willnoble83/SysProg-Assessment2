...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 697:	f7 f1                	div    %ecx
 699:	0f b6 92 c8 0a 00 00 	movzbl 0xac8(%edx),%edx
    }
    while ((x /= base) != 0);
...
void printf(int fd, const char *fmt, ...) {
 ...
 8b4:	e9 8f fe ff ff       	jmp    748 <printf+0x48>
                    s = "(null)";
 8b9:	bb be 0a 00 00       	mov    $0xabe,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 8d1:	a1 c0 0e 00 00       	mov    0xec0,%eax
void free(void *ap) {
 ...
 90d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 90f:	a3 c0 0e 00 00       	mov    %eax,0xec0
}
 914:	5b                   	pop    %ebx
 915:	5e                   	pop    %esi
 916:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 947:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 94a:	a3 c0 0e 00 00       	mov    %eax,0xec0
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 969:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 96c:	8b 15 c0 0e 00 00    	mov    0xec0,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 9af:	73 47                	jae    9f8 <malloc+0x98>
        ...
        if (p == freep) {
 9b1:	39 05 c0 0e 00 00    	cmp    %eax,0xec0
 ...
 9d6:	e8 f5 fe ff ff       	call   8d0 <free>
    return freep;
 9db:	8b 15 c0 0e 00 00    	mov    0xec0,%edx
 ...
 a04:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 a07:	89 15 c0 0e 00 00    	mov    %edx,0xec0
}
 ...
 a19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 a20:	c7 05 c0 0e 00 00 c4 	movl   $0xec4,0xec0
 a27:	0e 00 00 
 a2a:	c7 05 c4 0e 00 00 c4 	movl   $0xec4,0xec4
 a31:	0e 00 00 
        base.s.size = 0;
 a34:	b8 c4 0e 00 00       	mov    $0xec4,%eax
 a39:	c7 05 c8 0e 00 00 00 	movl   $0x0,0xec8
 a40:	00 00 00 
