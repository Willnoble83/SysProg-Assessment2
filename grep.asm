...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 6a7:	f7 f1                	div    %ecx
 6a9:	0f b6 92 d8 0a 00 00 	movzbl 0xad8(%edx),%edx
    }
    while ((x /= base) != 0);
...
void printf(int fd, const char *fmt, ...) {
 ...
 8c4:	e9 8f fe ff ff       	jmp    758 <printf+0x48>
                    s = "(null)";
 8c9:	bb ce 0a 00 00       	mov    $0xace,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 8e1:	a1 c0 0e 00 00       	mov    0xec0,%eax
void free(void *ap) {
 ...
 91d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 91f:	a3 c0 0e 00 00       	mov    %eax,0xec0
}
 924:	5b                   	pop    %ebx
 925:	5e                   	pop    %esi
 926:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 957:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 95a:	a3 c0 0e 00 00       	mov    %eax,0xec0
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 979:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 97c:	8b 15 c0 0e 00 00    	mov    0xec0,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 9bf:	73 47                	jae    a08 <malloc+0x98>
        ...
        if (p == freep) {
 9c1:	39 05 c0 0e 00 00    	cmp    %eax,0xec0
 ...
 9e6:	e8 f5 fe ff ff       	call   8e0 <free>
    return freep;
 9eb:	8b 15 c0 0e 00 00    	mov    0xec0,%edx
 ...
 a14:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 a17:	89 15 c0 0e 00 00    	mov    %edx,0xec0
}
 ...
 a29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 a30:	c7 05 c0 0e 00 00 c4 	movl   $0xec4,0xec0
 a37:	0e 00 00 
 a3a:	c7 05 c4 0e 00 00 c4 	movl   $0xec4,0xec4
 a41:	0e 00 00 
        base.s.size = 0;
 a44:	b8 c4 0e 00 00       	mov    $0xec4,%eax
 a49:	c7 05 c8 0e 00 00 00 	movl   $0x0,0xec8
 a50:	00 00 00 
