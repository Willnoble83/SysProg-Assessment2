...
static void printint(int fd, int xx, int base, int sgn) {
 ...
 687:	f7 f1                	div    %ecx
 689:	0f b6 92 b8 0a 00 00 	movzbl 0xab8(%edx),%edx
    }
    while ((x /= base) != 0);
...
void printf(int fd, const char *fmt, ...) {
 ...
 8a4:	e9 8f fe ff ff       	jmp    738 <printf+0x48>
                    s = "(null)";
 8a9:	bb ae 0a 00 00       	mov    $0xaae,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 937:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 93a:	a3 a0 0e 00 00       	mov    %eax,0xea0
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 99f:	73 47                	jae    9e8 <malloc+0x98>
        ...
        if (p == freep) {
 9a1:	39 05 a0 0e 00 00    	cmp    %eax,0xea0
 ...
 9c6:	e8 f5 fe ff ff       	call   8c0 <free>
    return freep;
 9cb:	8b 15 a0 0e 00 00    	mov    0xea0,%edx
 ...
 9f4:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 9f7:	89 15 a0 0e 00 00    	mov    %edx,0xea0
}
 ...
 a17:	0e 00 00 
 a1a:	c7 05 a4 0e 00 00 a4 	movl   $0xea4,0xea4
 a21:	0e 00 00 
        base.s.size = 0;
 a24:	b8 a4 0e 00 00       	mov    $0xea4,%eax
