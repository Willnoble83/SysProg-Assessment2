...
void free(void *ap) {
 ...
 611:	a1 d8 0a 00 00       	mov    0xad8,%eax
void free(void *ap) {
 ...
 64d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 64f:	a3 d8 0a 00 00       	mov    %eax,0xad8
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 68a:	a3 d8 0a 00 00       	mov    %eax,0xad8
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 6ac:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
        ...
        if (p == freep) {
 6f1:	39 05 d8 0a 00 00    	cmp    %eax,0xad8
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
    return freep;
 71b:	8b 15 d8 0a 00 00    	mov    0xad8,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 747:	89 15 d8 0a 00 00    	mov    %edx,0xad8
}
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
 760:	c7 05 d8 0a 00 00 dc 	movl   $0xadc,0xad8
 767:	0a 00 00 
 76a:	c7 05 dc 0a 00 00 dc 	movl   $0xadc,0xadc
 771:	0a 00 00 
        base.s.size = 0;
 774:	b8 dc 0a 00 00       	mov    $0xadc,%eax
 779:	c7 05 e0 0a 00 00 00 	movl   $0x0,0xae0
 780:	00 00 00 
