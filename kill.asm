...
void printf(int fd, const char *fmt, ...) {
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
                    s = "(null)";
 5d9:	bb bc 07 00 00       	mov    $0x7bc,%ebx
                while (*s != 0) {
...
void free(void *ap) {
 ...
 5f1:	a1 b8 0a 00 00       	mov    0xab8,%eax
void free(void *ap) {
 ...
 62d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 62f:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 66a:	a3 b8 0a 00 00       	mov    %eax,0xab8
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 68c:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
        ...
        if (p == freep) {
 6d1:	39 05 b8 0a 00 00    	cmp    %eax,0xab8
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
    return freep;
 6fb:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 727:	89 15 b8 0a 00 00    	mov    %edx,0xab8
}
 ...
 747:	0a 00 00 
 74a:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 751:	0a 00 00 
        base.s.size = 0;
 754:	b8 bc 0a 00 00       	mov    $0xabc,%eax
