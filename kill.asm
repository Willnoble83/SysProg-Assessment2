...
void free(void *ap) {
 ...
 63d:	89 08                	mov    %ecx,(%eax)
    ...
    freep = p;
 63f:	a3 c8 0a 00 00       	mov    %eax,0xac8
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
...
void free(void *ap) {
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
    freep = p;
 67a:	a3 c8 0a 00 00       	mov    %eax,0xac8
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
    if ((prevp = freep) == 0) {
 69c:	8b 15 c8 0a 00 00    	mov    0xac8,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 6df:	73 47                	jae    728 <malloc+0x98>
        ...
        if (p == freep) {
 6e1:	39 05 c8 0a 00 00    	cmp    %eax,0xac8
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
    return freep;
 70b:	8b 15 c8 0a 00 00    	mov    0xac8,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
 737:	89 15 c8 0a 00 00    	mov    %edx,0xac8
}
 ...
 757:	0a 00 00 
 75a:	c7 05 cc 0a 00 00 cc 	movl   $0xacc,0xacc
 761:	0a 00 00 
        base.s.size = 0;
 764:	b8 cc 0a 00 00       	mov    $0xacc,%eax
 769:	c7 05 d0 0a 00 00 00 	movl   $0x0,0xad0
 770:	00 00 00 
...
int test(void)
{
 ...
 7a3:	83 ec 10             	sub    $0x10,%esp
    printf(1,"Tested!");
 7a6:	68 e5 07 00 00       	push   $0x7e5
 7ab:	6a 01                	push   $0x1
 7ad:	e8 7e fc ff ff       	call   430 <printf>
    return 0;
