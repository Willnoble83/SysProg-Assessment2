...
void iputtest(void) {
    ...
    printf(stdout, "iput test\n");
     ...
     12b:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     1a8:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     1bf:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     1d6:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     1ed:	ff 35 b0 5e 00 00    	pushl  0x5eb0
...
void exitiputtest(void)  {
    ...
    printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    printf(stdout, "exitiput test ok\n");
     ...
     27d:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     298:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     2af:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     2c6:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     2dd:	ff 35 b0 5e 00 00    	pushl  0x5eb0
...
void openiputtest(void) {
    ...
    printf(stdout, "openiput test\n");
     ...
     2fb:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    if (pid == 0) {
     ...
     34a:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    printf(stdout, "openiput test ok\n");
     ...
     38a:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     3ac:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     3c3:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     3da:	ff 35 b0 5e 00 00    	pushl  0x5eb0
...
void opentest(void) {
    ...
    printf(stdout, "open test\n");
     ...
     3fb:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    printf(stdout, "open test ok\n");
     ...
     441:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     458:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     46f:	ff 35 b0 5e 00 00    	pushl  0x5eb0
...
void writetest(void) {
    ...
    printf(stdout, "small file test\n");
     ...
     48d:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    for (i = 0; i < 100; i++) {
     ...
     4c0:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    printf(stdout, "writes ok\n");
     ...
     518:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    if (fd >= 0) {
     ...
     54e:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    if (i == 2000) {
     ...
     582:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    printf(stdout, "small file test ok\n");
     ...
     5b0:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     5ce:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     5e7:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     5fe:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     615:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     62c:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     643:	ff 35 b0 5e 00 00    	pushl  0x5eb0
...
void writetest1(void) {
    ...
    printf(stdout, "big files test\n");
     ...
     66d:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    printf(stdout, "big files ok\n");
     ...
     765:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     783:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     79a:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     7ce:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     7e5:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     7fc:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     813:	ff 35 b0 5e 00 00    	pushl  0x5eb0
...
void createtest(void)      {
    ...
    printf(stdout, "many creates, followed by unlink test\n");
     ...
     841:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8c6:	ff 35 b0 5e 00 00    	pushl  0x5eb0
...
void dirtest(void){
    ...
    printf(stdout, "mkdir test\n");
     ...
     8eb:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    printf(stdout, "mkdir test ok\n");
     ...
     951:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     968:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     97f:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     996:	ff 35 b0 5e 00 00    	pushl  0x5eb0
     ...
     9ad:	ff 35 b0 5e 00 00    	pushl  0x5eb0
...
void exectest(void)      {
    ...
    printf(stdout, "exec test\n");
     ...
     9cb:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    if (exec("echo", echoargv) < 0) {
     ...
     9f7:	ff 35 b0 5e 00 00    	pushl  0x5eb0
...
void sbrktest(void)      {
    ...
    2d40:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    *lastaddr = 99;
    ...
    2fd3:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    2ff4:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    3027:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    3054:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    3073:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    308a:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    30a1:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    30b8:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    30cf:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    30e6:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    30fd:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    3119:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    3130:	ff 35 b0 5e 00 00    	pushl  0x5eb0
...
void validatetest(void)      {
    ...
    31c9:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    31eb:	ff 35 b0 5e 00 00    	pushl  0x5eb0
...
void bsstest(void)      {
    ...
    320b:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    324b:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    3263:	ff 35 b0 5e 00 00    	pushl  0x5eb0
...
void bigargtest(void)      {
    ...
    32f7:	ff 35 b0 5e 00 00    	pushl  0x5eb0
        args[MAXARG - 1] = 0;
    ...
    3324:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    3354:	ff 35 b0 5e 00 00    	pushl  0x5eb0
    ...
    336b:	ff 35 b0 5e 00 00    	pushl  0x5eb0
...
00003630 <rand>:
    randstate = randstate * 1664525 + 1013904223;
    3630:	69 05 ac 5e 00 00 0d 	imul   $0x19660d,0x5eac,%eax
    3637:	66 19 00 
unsigned int rand()              {
    363a:	55                   	push   %ebp
    ...
    3643:	a3 ac 5e 00 00       	mov    %eax,0x5eac
}
    3648:	c3                   	ret    
...
static void printint(int fd, int xx, int base, int sgn) {
    ...
    39c7:	f7 f1                	div    %ecx
    39c9:	0f b6 92 58 55 00 00 	movzbl 0x5558(%edx),%edx
    }
    while ((x /= base) != 0);
...
void printf(int fd, const char *fmt, ...) {
    ...
    3be4:	e9 8f fe ff ff       	jmp    3a78 <printf+0x48>
                    s = "(null)";
    3be9:	bb 50 55 00 00       	mov    $0x5550,%ebx
                while (*s != 0) {
...
void free(void *ap) {
    ...
    3c01:	a1 60 5f 00 00       	mov    0x5f60,%eax
void free(void *ap) {
    ...
    freep = p;
    3c3f:	a3 60 5f 00 00       	mov    %eax,0x5f60
}
    3c44:	5b                   	pop    %ebx
    3c45:	5e                   	pop    %esi
    3c46:	5f                   	pop    %edi
...
void free(void *ap) {
    ...
    freep = p;
    3c7a:	a3 60 5f 00 00       	mov    %eax,0x5f60
        p->s.size += bp->s.size;
...
void* malloc(uint nbytes) {
    ...
    if ((prevp = freep) == 0) {
    3c9c:	8b 15 60 5f 00 00    	mov    0x5f60,%edx
    nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
    ...
    3cdf:	73 47                	jae    3d28 <malloc+0x98>
        ...
        if (p == freep) {
    3ce1:	39 05 60 5f 00 00    	cmp    %eax,0x5f60
    ...
    return freep;
    3d0b:	8b 15 60 5f 00 00    	mov    0x5f60,%edx
    ...
    3d34:	89 78 04             	mov    %edi,0x4(%eax)
            freep = prevp;
    3d37:	89 15 60 5f 00 00    	mov    %edx,0x5f60
}
    ...
    3d49:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        base.s.ptr = freep = prevp = &base;
    3d50:	c7 05 60 5f 00 00 64 	movl   $0x5f64,0x5f60
    3d57:	5f 00 00 
    3d5a:	c7 05 64 5f 00 00 64 	movl   $0x5f64,0x5f64
    3d61:	5f 00 00 
        base.s.size = 0;
    3d64:	b8 64 5f 00 00       	mov    $0x5f64,%eax
    3d69:	c7 05 68 5f 00 00 00 	movl   $0x0,0x5f68
    3d70:	00 00 00 
...
int test(void)
{
    ...
    3da3:	83 ec 10             	sub    $0x10,%esp
    printf(1,"Tested!");
    3da6:	68 69 55 00 00       	push   $0x5569
    3dab:	6a 01                	push   $0x1
    3dad:	e8 7e fc ff ff       	call   3a30 <printf>
    return 0;
